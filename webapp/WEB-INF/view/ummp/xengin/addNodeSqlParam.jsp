...
<body>
	<div class="top_table" align="center" style="width:300px;padding-left: 2px">
	     <br>
	     <form id = "nodeParamForm">
		 <table class="easyui-datagrid" id= "npdg"
		 		data-options="title:'节点参数',
		 		url:'initNodeParamUrl?id=<%=request.getParameter("id")%>',
				striped : true,
				idField : 'id',
				height : 300,
				width : 1000,
			...
			<thead> 
			 <tr>
			  	...
			  	<th data-options="field:'code',width:100,align:'center'">参数编码</th>
		 		<th data-options="field:'name',width:100,align:'center'">参数名称</th>
		 		<th data-options="field:'type',width:100,align:'center'">参数类型</th>
		 		<th data-options="field:'valueType',width:80,align:'center'">参数值类型</th>
		 		<th data-options="field:'value',width:350,align:'left'">参数值</th>
		 		<th data-options="field:'subType',width:100,align:'center'">参数域</th>
			 </tr>
			</thead>
		 </table>
		 ...
		 <div>
		  ...
		  <!-- SQL ID -->
		  <input type="hidden" name = "sqlId"  id = "sqlId" value="<%=request.getParameter("sqlId")%>">
		 </div>
		 </form>
	</div>
</body>
