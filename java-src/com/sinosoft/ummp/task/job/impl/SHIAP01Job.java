 ...
 */
@Service
public class SHIAP01Job extends SuperJob implements SubmitJob {
	...
	public boolean submit(String startDate, String endDate) {
		//获取平台
		System.out.println("================= 上海人身险数据报送,客户身份核对信息上传同步批处理开始 =================");
...
//			return false;
			...
			System.out.println("=================上海人身险数据报送,客户身份核对信息上传同步批处理结束 =================");	
		}
		return true;
	}
