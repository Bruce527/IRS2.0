 ...
 */
@Service
public class SHIAP02Job extends SuperJob implements SubmitJob {
	...
	public boolean submit(String startDate, String endDate) {
		//获取平台
		System.out.println("================= 上海人身险数据报送,客户身份核对信息上传异步批处理开始 =================");
		...
		try{
			 ...
			 pojo.setBussType("SHIAP02");
			 pojo.setBussNo("");
			 pojo.setBatchNo("");// 不赋值,sql995替换参数时为空
			 //pojo.setPolicyNo("");
...
//			return false;
			...
			System.out.println("=================上海人身险数据报送,客户身份核对信息上传异步批处理结束 =================");	
		}
		return true;
	}
