 ...
 */
@Service
public class SHIAN03Job extends SuperJob implements SubmitJob {
	...
	public boolean submit(String startDate, String endDate) {
		//获取平台
		System.out.println("================= 上海人身险数据报送,团单承保信息异步拆单查询批处理开始 =================");
...
//			return false;
			...
			System.out.println("=================上海人身险数据报送,团单承保信息异步拆单查询批处理结束 =================");	
		}
		return true;
	}
