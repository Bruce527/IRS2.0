 ...
 */
@Service
public class SHIAE0101Job extends SuperJob implements SubmitJob {
	...
	public boolean submit(String startDate, String endDate) {
		//获取平台
		System.out.println("================= 上海人身险数据报送,团单保全信息同步上传批处理开始 =================");
...
//			return false;
			...
			System.out.println("=================上海人身险数据报送,团单保全信息同步上传批处理结束 =================");	
		}
		return true;
	}
	
	public static void main (String[] args ){
		SHIAE0101Job shJob=new SHIAE0101Job();
		try {
			shJob.excute();
		} catch (Exception e) {
			e.printStackTrace();
