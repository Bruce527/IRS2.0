 ...
 */
@Service
public class SHIAU0102Job extends SuperJob implements SubmitJob {
	...
	public boolean submit(String startDate, String endDate) {
		//获取平台
		System.out.println("================= 上海人身险数据报送,个单核保信息同步上传批处理开始 =================");
...
//			return false;
			...
			System.out.println("=================上海人身险数据报送,个单核保信息同步上传批处理结束 =================");	
		}
		return true;
	}
