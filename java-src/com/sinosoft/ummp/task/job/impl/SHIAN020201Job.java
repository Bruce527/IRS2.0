 ...
 */
@Service
public class SHIAN020201Job extends SuperJob implements SubmitJob {
	
	public SHIAN020201Job(){
		//设置为报送群组
	...
	public boolean submit(String startDate, String endDate) {
		//获取平台
		System.out.println("================= 上海人身险数据报送,承保信息异步拆单批处理开始 =================");
...
//			return false;
			...
			System.out.println("=================上海人身险数据报送,承保信息异步拆单上传批处理结束 =================");	
		}
		return true;
	}
