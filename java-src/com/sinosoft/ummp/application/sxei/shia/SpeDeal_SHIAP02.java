 ...
 */
@Service
public class SpeDeal_SHIAP02 extends MsgClassService{
	private static Logger logger = Logger.getLogger(SpeDeal_SHIAP02.class);
	@Autowired
		...
		for(int i = 0; i < maps.size();i++){
			...
			for(TDefMsgNode msgNode : msgNodes){
				...
				if(map != null){
					...
					if(text == null || "NULL".equals(text) || "null".equals(text) || "".equals(text)){
						//重新赋值
						text = "";
					}
				}
