 ...
 * @company SINOSOFT
 */
@Service("sHIAN020203RDeal")
public class SHIAN020203RDeal implements ReturnDealService {
	...
	private void dealLCPoltransaction(Map<String, String> map) {
		//更新表
		//如果异步拆单结束报送结果为1-成功， 把数据更新为异步结果查询待上报状态
		...
		if(responseCode.equals("1")){
			 ...
			 sql = "update t_shia_lcpoltransaction set stateflag='1'"
						...
						+",batch_sequence_no = '"+map.get("BOOKING_SEQUENCE_NO")+"'"
