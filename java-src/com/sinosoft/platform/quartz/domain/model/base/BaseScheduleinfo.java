...
public abstract class BaseScheduleinfo  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.sinosoft.platform.quartz.domain.model.Scheduleinfo)) return false;
		else {
			com.sinosoft.platform.quartz.domain.model.Scheduleinfo scheduleinfo = (com.sinosoft.platform.quartz.domain.model.Scheduleinfo) obj;
