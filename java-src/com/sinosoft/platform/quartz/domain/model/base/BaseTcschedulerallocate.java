...
public abstract class BaseTcschedulerallocate  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.sinosoft.platform.quartz.domain.model.Tcschedulerallocate)) return false;
		else {
			com.sinosoft.platform.quartz.domain.model.Tcschedulerallocate tcschedulerallocate = (com.sinosoft.platform.quartz.domain.model.Tcschedulerallocate) obj;
