...
public abstract class BaseJobDetails  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.sinosoft.platform.quartz.domain.model.JobDetails)) return false;
		else {
			com.sinosoft.platform.quartz.domain.model.JobDetails jobDetails = (com.sinosoft.platform.quartz.domain.model.JobDetails) obj;
