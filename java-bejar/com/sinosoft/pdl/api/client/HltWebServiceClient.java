...
import com.ebao.health.insurance.InsuranceWebServicePort;
import com.ebao.health.insurance.InsuranceWebServicePortService;
import com.ebao.health.insurance.InsuranceWebServicePortServiceLocator;
import com.sinosoft.pdl.constants.HltWSConstants;
 ...
 * @company SINOSOFT
 */
public class HltWebServiceClient {
	
	/** Web service 接口
	 */
	private InsuranceWebServicePortService service 
			= new InsuranceWebServicePortServiceLocator();
	
	/** 服务端口
	 */
	private InsuranceWebServicePort servicePort;
	 ...
	 * @param comId
	 */
	public HltWebServiceClient(BigDecimal comId) {
		try {
			// 获取服务端口
			servicePort = service.getInsuranceWebService();
	...
	private Method getWSMethodByBizType(String serviceId) {
		try {
			...
			String webServiceMethodName = HltWSConstants
