/**
 * AccidentPolicyUpcoverageLogDTO.java
 *
...
public class AccidentPolicyUpcoverageLogDTO  implements java.io.Serializable {
    private com.ebao.accident.insurance.dto.AccidentPolicyCoverageLogDTO[] accidentPolicyCoverageLogDTOs;
    ...
    public AccidentPolicyUpcoverageLogDTO() {
    }

    public AccidentPolicyUpcoverageLogDTO(
           com.ebao.accident.insurance.dto.AccidentPolicyCoverageLogDTO[] accidentPolicyCoverageLogDTOs,
           ...
           this.accidentPolicyCoverageLogDTOs = accidentPolicyCoverageLogDTOs;
    ...
    /**
     * Gets the accidentPolicyCoverageLogDTOs value for this AccidentPolicyUpcoverageLogDTO.
     * 
     * @return accidentPolicyCoverageLogDTOs
     */
    public com.ebao.accident.insurance.dto.AccidentPolicyCoverageLogDTO[] getAccidentPolicyCoverageLogDTOs() {
        return accidentPolicyCoverageLogDTOs;
    }


    /**
     * Sets the accidentPolicyCoverageLogDTOs value for this AccidentPolicyUpcoverageLogDTO.
     * 
     * @param accidentPolicyCoverageLogDTOs
     */
    public void setAccidentPolicyCoverageLogDTOs(com.ebao.accident.insurance.dto.AccidentPolicyCoverageLogDTO[] accidentPolicyCoverageLogDTOs) {
        this.accidentPolicyCoverageLogDTOs = accidentPolicyCoverageLogDTOs;
    }


    /**
     * Gets the comCoverageCode value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Sets the comCoverageCode value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Gets the coverageCode value for this AccidentPolicyUpcoverageLogDTO.
     * 
     * @return coverageCode
     */
    ...
    /**
     * Sets the coverageCode value for this AccidentPolicyUpcoverageLogDTO.
     * 
     * @param coverageCode
     */
    ...
    /**
     * Gets the coverageEffectiveDate value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Sets the coverageEffectiveDate value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Gets the coverageExpireDate value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Sets the coverageExpireDate value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Gets the coverageName value for this AccidentPolicyUpcoverageLogDTO.
     * 
     * @return coverageName
     */
    ...
    /**
     * Sets the coverageName value for this AccidentPolicyUpcoverageLogDTO.
     * 
     * @param coverageName
     */
    ...
    /**
     * Gets the coveragePremium value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Sets the coveragePremium value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Gets the coverageSuminsured value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Sets the coverageSuminsured value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Gets the mainAttachedFlag value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Sets the mainAttachedFlag value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Gets the paymentMethod value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Sets the paymentMethod value for this AccidentPolicyUpcoverageLogDTO.
     * 
     * @param paymentMethod
     */
    ...
    /**
     * Gets the paymentYears value for this AccidentPolicyUpcoverageLogDTO.
     * 
     * @return paymentYears
     */
    ...
    /**
     * Sets the paymentYears value for this AccidentPolicyUpcoverageLogDTO.
     * 
     * @param paymentYears
     */
    ...
    /**
     * Gets the specificBusiness value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Sets the specificBusiness value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Gets the specificBusinessCode value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    /**
     * Sets the specificBusinessCode value for this AccidentPolicyUpcoverageLogDTO.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AccidentPolicyUpcoverageLogDTO)) return false;
        AccidentPolicyUpcoverageLogDTO other = (AccidentPolicyUpcoverageLogDTO) obj;
        ...
        boolean _equals;
        _equals = true && 
            ((this.accidentPolicyCoverageLogDTOs==null && other.getAccidentPolicyCoverageLogDTOs()==null) || 
             (this.accidentPolicyCoverageLogDTOs!=null &&
              java.util.Arrays.equals(this.accidentPolicyCoverageLogDTOs, other.getAccidentPolicyCoverageLogDTOs()))) &&
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        if (getAccidentPolicyCoverageLogDTOs() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getAccidentPolicyCoverageLogDTOs());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getAccidentPolicyCoverageLogDTOs(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AccidentPolicyUpcoverageLogDTO.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dto.insurance.accident.ebao.com", "AccidentPolicyUpcoverageLogDTO"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("accidentPolicyCoverageLogDTOs");
        elemField.setXmlName(new javax.xml.namespace.QName("", "accidentPolicyCoverageLogDTOs"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://dto.insurance.accident.ebao.com", "AccidentPolicyCoverageLogDTO"));
