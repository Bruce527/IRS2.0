/**
 * SpecialPolicyCoverageLogDTO.java
 *
...
public class SpecialPolicyCoverageLogDTO  implements java.io.Serializable {
    ...
    private com.ebao.health.insurance.dto.SpecialPolicyAmountLogDTO[] specialPolicyAmountLogDTOs;
    ...
    public SpecialPolicyCoverageLogDTO() {
    }
    ...
    public SpecialPolicyCoverageLogDTO(
           ...
           com.ebao.health.insurance.dto.SpecialPolicyAmountLogDTO[] specialPolicyAmountLogDTOs,
           ...
           this.specialPolicyAmountLogDTOs = specialPolicyAmountLogDTOs;
    ...
    /**
     * Gets the effectivelyAmount value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Sets the effectivelyAmount value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Gets the liabilityClassification value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Sets the liabilityClassification value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Gets the liabilityCode value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Sets the liabilityCode value for this SpecialPolicyCoverageLogDTO.
     * 
     * @param liabilityCode
     */
    ...
    /**
     * Gets the liabilityCurrentPremium value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Sets the liabilityCurrentPremium value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Gets the liabilityEffectiveDate value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Sets the liabilityEffectiveDate value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Gets the liabilityExpireDate value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Sets the liabilityExpireDate value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Gets the liabilityName value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Sets the liabilityName value for this SpecialPolicyCoverageLogDTO.
     * 
     * @param liabilityName
     */
    ...
    /**
     * Gets the liabilityPremium value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Sets the liabilityPremium value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Gets the liabilityStatus value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Sets the liabilityStatus value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Gets the limitAmount value for this SpecialPolicyCoverageLogDTO.
     * 
     * @return limitAmount
     */
    ...
    /**
     * Sets the limitAmount value for this SpecialPolicyCoverageLogDTO.
     * 
     * @param limitAmount
     */
    ...
    /**
     * Gets the specialPolicyAmountLogDTOs value for this SpecialPolicyCoverageLogDTO.
     * 
     * @return specialPolicyAmountLogDTOs
     */
    public com.ebao.health.insurance.dto.SpecialPolicyAmountLogDTO[] getSpecialPolicyAmountLogDTOs() {
        return specialPolicyAmountLogDTOs;
    }


    /**
     * Sets the specialPolicyAmountLogDTOs value for this SpecialPolicyCoverageLogDTO.
     * 
     * @param specialPolicyAmountLogDTOs
     */
    public void setSpecialPolicyAmountLogDTOs(com.ebao.health.insurance.dto.SpecialPolicyAmountLogDTO[] specialPolicyAmountLogDTOs) {
        this.specialPolicyAmountLogDTOs = specialPolicyAmountLogDTOs;
    }


    /**
     * Gets the waitingPeriod value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Sets the waitingPeriod value for this SpecialPolicyCoverageLogDTO.
     * 
     * @param waitingPeriod
     */
    ...
    /**
     * Gets the liabilityDayAmount value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Sets the liabilityDayAmount value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Gets the liabilitydayEffectiveAmount value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    /**
     * Sets the liabilitydayEffectiveAmount value for this SpecialPolicyCoverageLogDTO.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SpecialPolicyCoverageLogDTO)) return false;
        SpecialPolicyCoverageLogDTO other = (SpecialPolicyCoverageLogDTO) obj;
        ...
        _equals = true && 
            ...
            ((this.specialPolicyAmountLogDTOs==null && other.getSpecialPolicyAmountLogDTOs()==null) || 
             (this.specialPolicyAmountLogDTOs!=null &&
              java.util.Arrays.equals(this.specialPolicyAmountLogDTOs, other.getSpecialPolicyAmountLogDTOs()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getSpecialPolicyAmountLogDTOs() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSpecialPolicyAmountLogDTOs());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSpecialPolicyAmountLogDTOs(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SpecialPolicyCoverageLogDTO.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dto.insurance.health.ebao.com", "SpecialPolicyCoverageLogDTO"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("specialPolicyAmountLogDTOs");
        elemField.setXmlName(new javax.xml.namespace.QName("", "specialPolicyAmountLogDTOs"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://dto.insurance.health.ebao.com", "SpecialPolicyAmountLogDTO"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
